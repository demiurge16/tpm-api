...
open class ProjectDatabaseModel(
    ...
    @ElementCollection @CollectionTable @Column(nullable = false, length = 16) open var targetLanguages: List<String>,
    ...
    @OneToMany(mappedBy = "project", fetch = FetchType.LAZY) open var teamMembers: MutableList<TeamMemberDatabaseModel>,
    @OneToMany(mappedBy = "project", fetch = FetchType.LAZY) open var tasks: MutableList<TaskDatabaseModel>,
    @OneToMany(mappedBy = "project", fetch = FetchType.LAZY) open var expenses: MutableList<ExpenseDatabaseModel>,
    @OneToMany(mappedBy = "project", fetch = FetchType.LAZY) open var notes: MutableList<NoteDatabaseModel>,
    @OneToMany(mappedBy = "project", fetch = FetchType.LAZY) open var files: MutableList<FileDatabaseModel>,
    @OneToMany(mappedBy = "project", fetch = FetchType.LAZY) open var chats: MutableList<ChatDatabaseModel>,
